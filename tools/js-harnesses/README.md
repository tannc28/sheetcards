# Card-JS manual test harnesses

Standalone HTML/JS pages for **manually** exercising the card-template JavaScript
(AI Help/Ask/Checker, the math/markdown renderer, regex behavior) in a browser.
