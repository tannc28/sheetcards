...
from .compat import (
    ...
    QSpinBox, QCheckBox, Frame_HLine, Frame_Sunken, AlignCenter, 
    Font_Bold, DialogAccepted, MessageBox_Ok, safe_exec_dialog, showWarning
)
...
class AnkiWebSyncConfigDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        from .config_manager import (
            get_ankiweb_sync_mode, get_ankiweb_sync_timeout, 
    ...
    def _setup_ui(self):
        ...
        # Descrição geral
        desc = QLabel("Configure se o Sheets2Anki deve automaticamente sincronizar com AnkiWeb após sincronizar decks remotos.")
...
<b>Recomendado para:</b> Quando você tem certeza que a versão local é a mais atual."""
    ...
    def _save_settings(self):
        ...
        try:
            from .config_manager import (
                set_ankiweb_sync_mode, set_ankiweb_sync_timeout,
                set_ankiweb_sync_notifications
            )
