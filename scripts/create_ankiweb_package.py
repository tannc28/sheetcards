...
def create_ankiweb_package():
    ...
    for root, dirs, files in os.walk(package_dir):
        ...
        for d in dirs_to_remove:
            ...
            print(f"   🗑️  Removed: {os.path.relpath(os.path.join(root, d), package_dir)}/__pycache__")
    ...
    if cache_found:
        print("   ❌ CRITICAL ERROR: AnkiWeb does not accept files with __pycache__ or .pyc!")
        return False
    else:
    ...
    if manifest:
        print(f"   🎯 Compatibility: Anki {manifest.get('min_point_version', 'N/A')} - {manifest.get('max_point_version', 'N/A')}")
    else:
        print(f"   🎯 Compatibility: Anki N/A - N/A")
